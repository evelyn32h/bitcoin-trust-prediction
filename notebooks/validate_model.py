...
def validate_model_on_fold(args):
    ...
    """
    fold, G_val, model, scaler, cycle_length, predictions_per_fold, pos_edges_ratio = args
    ...
    for idx, (u, v, data) in enumerate(validation_edges_sample):
        ...
        X_test, y_test, _ = feature_matrix_from_graph(G_val, edges=[(u, v, data)], k=cycle_length)
...
def validate_all_models(validation_sets, models_and_scalers, cycle_length, predictions_per_fold, pos_edges_ratio):
    """
    ...
    fold_args = [
        (fold, G_val, model, scaler, cycle_length, predictions_per_fold, pos_edges_ratio)
