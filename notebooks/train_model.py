...
def train_model_on_set(G_train, cycle_length=4):
    """
...
def train_all_models(training_sets, cycle_length):
    ...
    for fold, G_train in enumerate(training_sets):
        ...
        model, scaler = train_model_on_set(G_train, cycle_length=cycle_length)
...
def main():
    ...
    models_and_scalers = train_all_models(training_sets, args.cycle_length)
